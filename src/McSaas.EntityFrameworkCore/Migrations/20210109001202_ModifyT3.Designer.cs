...
namespace McSaas.Migrations
{
    ...
    [Migration("20210109001202_ModifyT3")]
    partial class ModifyT3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("McSaas.App.Buildings.Building", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("McSaas.Communitys.Community", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("McSaas.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("McSaas.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("McSaas.Houses.House", b =>
                {
                    b.HasOne("McSaas.App.Buildings.Building", "Building")
                        .WithMany()
