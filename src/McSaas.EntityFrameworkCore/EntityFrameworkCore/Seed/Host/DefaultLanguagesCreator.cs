...
namespace McSaas.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly McSaasDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = McSaasConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(McSaasDbContext context)
        {
            _context = context;
        }
