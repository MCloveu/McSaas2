...
{
    public abstract class McSaasWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static McSaasWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(McSaasWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<McSaasDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<McSaasDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<McSaasDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<McSaasDbContext, Task<T>> func)
        {
            T result;
